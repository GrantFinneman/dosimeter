    ...
    for width in range(5, 51, 5):
        for height in range(5, 51, 5):
            for angle in range(0, 360, 15):
                ...
                call(f'sed -i "s:/gate/output/ascii/setFileName output/.*:/gate/output/ascii/setFileName output/E{pad_energy}__W{pad_width}__H{pad_height}__A{pad_angle}_cubes_:" mac/run.mac', shell=True)
